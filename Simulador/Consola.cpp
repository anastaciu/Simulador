...
void Consola::setTextSizeXP(int x, int y){
	...
	SetConsoleFont_ SetConsoleFont = _Post_ _Notnull_ reinterpret_cast<SetConsoleFont_>(GetProcAddress(GetModuleHandle(L"kernel32.dll"), "SetConsoleFont"));
	GetConsoleFontInfo_ GetConsoleFontInfo = _Post_ _Notnull_ reinterpret_cast<GetConsoleFontInfo_>(GetProcAddress(GetModuleHandle(L"kernel32.dll"), "GetConsoleFontInfo"));
	GetNumberOfConsoleFonts_ GetNumberOfConsoleFonts = _Post_ _Notnull_ reinterpret_cast<GetNumberOfConsoleFonts_>(GetProcAddress(GetModuleHandle(L"kernel32.dll"), "GetNumberOfConsoleFonts"));
